...
> [!NOTE]
> This crawler is compatible with any other `--infohash` source in `hash1hash2...` binary format ([online API](https://github.com/YGGverse/aquatic-crawler/wiki/Online-API))
